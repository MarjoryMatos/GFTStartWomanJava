...
/*
 *Dada as seguintes informações de id e contato, crie um dicionário e ordene este dicionário exibindo 
 *(Nome id - Nome contato);
 *
 *id = 1 - Contato = nome: Simba, numero: 2222;
 *id = 4 - Contato = nome: Cami, numero: 5555;
 *id = 3 - Contato =m nome: Jan, numero: 1111;
 */
...
public class Exercicios {
	...
	public static void main(String[] args) {
		...
		//classe anonima
		System.out.println("--\tOrdem telefone contato\t--");
